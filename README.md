...
```
# Output:
<img width="788" height="419" alt="image" src="https://github.com/user-attachments/assets/c607ed49-5a3f-4fa0-9c2c-d1659a9abb90" />
...
```
# Output:
<img width="791" height="422" alt="image" src="https://github.com/user-attachments/assets/875c2bbb-d8b2-4636-9b28-3ba8003db41f" />
...
```
# Output:
<img width="796" height="427" alt="image" src="https://github.com/user-attachments/assets/3b4c2750-2908-491d-9380-46b49d44ec05" />
...
```
# Output:
<img width="753" height="553" alt="image" src="https://github.com/user-attachments/assets/2e8bf1da-d993-4e8e-b8e8-ffa3aed26cee" />
...
```
# Output:
<img width="795" height="425" alt="image" src="https://github.com/user-attachments/assets/4b302e91-05c2-4049-ac6d-87577c8435a6" />
